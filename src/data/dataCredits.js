...
export const DATA_CREDITS = [
  ...
  },
  {
    ...
    html:
      'Live rail vehicles: ' +
      '<a href="https://entur.org/national-travel-apps/" target="_blank" rel="noopener">Entur GTFS-RT (Norway)</a> &amp; ' +
      '<a href="https://www.mbta.com/developers/v3-api" target="_blank" rel="noopener">MBTA V3 API (Boston)</a>',
  },
  {
    key: 'radio-browser',
    html:
