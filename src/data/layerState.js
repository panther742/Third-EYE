...
export const LAYER_STATE_STORAGE_KEY = 'gev:layer-state:v3-live';
...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'trains', token: 'n', disposition: 'enabled-only' }),
]);
...
export function createDefaultLayerState() {
  return {
    ...
    // LIVE-DEFAULTS (local patch): keyless real-data layers ship ON so a fresh
    // globe opens with live aircraft, military traffic, satellites, earthquakes
    // and rocket launches instead of an empty planet.
    enabledLayerIds: ['flights', 'military', 'satellites', 'earthquakes', 'rocket-launches'],
